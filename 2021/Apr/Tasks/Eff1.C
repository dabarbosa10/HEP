{
  ...
  //gStyle->SetOptFit(0);
   ...
   TH1F*hTPt0=(TH1F*)f0->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt00=(TH1F*)f0->Get("NRecoTau1/Tau1Pt");
   
   TH1F*hTPt1=(TH1F*)f1->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt01=(TH1F*)f1->Get("NRecoTau1/Tau1Pt");

   TH1F*hTPt2=(TH1F*)f2->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt02=(TH1F*)f2->Get("NRecoTau1/Tau1Pt");

   TH1F*hTPt3=(TH1F*)f3->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt03=(TH1F*)f3->Get("NRecoTau1/Tau1Pt");

   TH1F*hTPt4=(TH1F*)f4->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt04=(TH1F*)f4->Get("NRecoTau1/Tau1Pt");

   TH1F*hTPt5=(TH1F*)f5->Get("NRecoVertex/Tau1Pt");
   TH1F*hTPt05=(TH1F*)f5->Get("NRecoTau1/Tau1Pt");
