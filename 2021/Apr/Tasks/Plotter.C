{
 ...
 //source  ~/.bash_profile
  ...
  hTPt0->SetTitle("Signal Samples ; m_{rec}(e, #tau, #Delta p_{T})  ; a.u");
          leg1=new TLegend(0.6,0.6,0.93,0.89);
          //leg1->SetHeader("CMS Preliminary","C");
	  leg1->SetBorderSize(0);
		   leg1->SetHeader("gl=gh=1","C");
          leg1->AddEntry(hTPt0,"1000 GeV","l");
          leg1->AddEntry(hTPt1,"1250 GeV","l");
          leg1->AddEntry(hTPt2,"1750 GeV","l");
          leg1->AddEntry(hTPt3,"2000 GeV","l");
          leg1->AddEntry(hTPt4,"2250 GeV","l");
...
c0->SaveAs("SignalSamplesgl1_recMass.eps")
}