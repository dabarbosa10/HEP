{
  ...
  //gStyle->SetOptFit(0);
   ...
   TFile *f0  = new TFile("Zprime_NonUniversalSSM_M500_gl6p0_gh6p0.root");
   TFile *f1  = new TFile("Zprime_NonUniversalSSM_M1000_gl6p0_gh6p0.root");
   TFile *f2  = new TFile("Zprime_NonUniversalSSM_M1500_gl6p0_gh6p0.root");
   TFile *f3  = new TFile("Zprime_NonUniversalSSM_M2000_gl6p0_gh6p0.root");
   TFile *f4  = new TFile("Zprime_NonUniversalSSM_M2500_gl6p0_gh6p0.root");
   TFile *f5  = new TFile("Zprime_NonUniversalSSM_M3500_gl6p0_gh6p0.root");
