{
  ...
  gStyle->SetOptFit(0);
  	...
  	TFile *f00  = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/Data.root");
	...
	B_data->SetLineColor(1);
  	...
  	TFile *C0 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/Data.root");
   ...
   TFile *D0 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/Data.root");
   ...
   TFile *B1 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/DY+Jets.root");
	TH1F *B_dy = (TH1F*)B1->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
	

	TFile *C1 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/DY+Jets.root");
	TH1F *C_dy = (TH1F*)C1->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");


	TFile *D1 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/DY+Jets.root");
	TH1F *D_dy = (TH1F*)D1->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

   TFile *B2 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/SingleTop.root");
	TH1F *B_st = (TH1F*)B2->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
	
	TFile *C2 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/SingleTop.root");
	TH1F *C_st = (TH1F*)C2->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

	TFile *D2 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/SingleTop.root");
	TH1F *D_st = (TH1F*)D2->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");




	TFile *B3 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/tbar{t}.root");
	TH1F *B_tt = (TH1F*)B3->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
	
	TFile *C3 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/tbar{t}.root");
	TH1F *C_tt = (TH1F*)C3->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

	TFile *D3 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/tbar{t}.root");
	TH1F *D_tt = (TH1F*)D3->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");




	TFile *B4 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/VV.root");
	TH1F *B_vv = (TH1F*)B4->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

	TFile *C4 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/VV.root");
	TH1F *C_vv = (TH1F*)C4->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

	TFile *D4 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/VV.root");
	TH1F *D_vv = (TH1F*)D4->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

  	TFile *B5 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/B/W+Jets.root");
	TH1F *B_wj = (TH1F*)B5->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
	
	TFile *C5 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/C/W+Jets.root");
	TH1F *C_wj = (TH1F*)C5->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");

	TFile *D5 = new TFile("/Users/diegobarbosa/Desktop/DYStudies/QCDNICOLAS/2018/D/W+Jets.root");
